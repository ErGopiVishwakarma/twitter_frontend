...
const Profile = () => {
  ...
  const userProfile = async () => {
    try {
      ...
      const { data } = await axios.get(`https://crazy-dove-vest.cyclic.app/user/profile/${userId}`, config)
  ...
  const followUser = async () => {
    try {
      ...
      const { data } = await axios.put(`https://crazy-dove-vest.cyclic.app/user/follow`, {
  ...
  const unfollowUser = async () => {
    try {
      ...
      const { data } = await axios.put(`https://crazy-dove-vest.cyclic.app/user/unfollow`, {
  ...
  const changeBg = async (parameter) => {
    try {
      ...
      const { data } = await axios.put(`https://crazy-dove-vest.cyclic.app/user/bgpicchange`, {
        bgpic: parameter
      }, config)
      setAgainRender(prev => !prev)
